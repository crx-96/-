...
test('cmp, eq, gt, gte, lt, lte', function () {
  ...
  function t(a, b, expected) {
    test.areEqual(String(expected), String(new Big(a).cmp(b)));

    if (expected === 1) {
      test.isTrue(new Big(a).gt(b));
      test.isTrue(new Big(a).gte(b));
      test.isTrue(!new Big(a).eq(b));
      test.isTrue(!new Big(a).lt(b));
      test.isTrue(!new Big(a).lte(b));
    } else if (expected === -1) {
      test.isTrue(new Big(a).lt(b));
      test.isTrue(new Big(a).lte(b));
      test.isTrue(!new Big(a).eq(b));
  ...
  test.isTrue(n.eq(n));
  test.isTrue(n.eq(1));
  test.isTrue(n.eq('1.0'));
  test.isTrue(n.eq('1.000000'));
  test.isTrue(n.eq(new Big(1)));
  test.isTrue(n.gt(0.99999));
  test.isTrue(!n.gte(1.1));
  test.isTrue(n.lt(1.001));
  test.isTrue(n.lte(2));

  n = new Big('-0.1');
  test.isTrue(!n.eq(0.1));
  test.isTrue(!n.gt(-0.1));
  test.isTrue(n.gte(-1));
  test.isTrue(n.lt(-0.01));
  test.isTrue(!n.lte(-1));

  n = new Big('0.0000000');
  test.isTrue(n.eq(-0));
  test.isTrue(n.gt(-0.000001));
  test.isTrue(!n.gte(0.1));
  test.isTrue(n.lt(0.0001));
  test.isTrue(n.lte(-0));

  n = new Big(-0);
  test.isTrue(n.eq('0.000'));
  test.isTrue(n.gt(-1));
  test.isTrue(!n.gte(0.1));
  test.isTrue(!n.lt(0));
  test.isTrue(n.lt(0.1));
  test.isTrue(n.lte(0));

  n = new Big('-1.234e+2');
  test.isTrue(n.eq(-123.4));
  test.isTrue(n.gte('-1.234e+3'));
  test.isTrue(n.lt(-123.39999));
  test.isTrue(n.lte('-123.4e+0'));

  n = new Big('5e-200');
  test.isTrue(n.eq(5e-200));
  test.isTrue(n.gt(5e-201));
  test.isTrue(!n.gte(1));
  test.isTrue(n.lt(6e-200));
  test.isTrue(n.lte(5.1e-200));

  n = new Big('1');
  test.isTrue(n.eq(n));
  test.isTrue(n.eq(n.toString()));
  test.isTrue(n.eq(n.valueOf()));
  test.isTrue(n.eq(n.toFixed()));
  test.isTrue(n.eq(1));
  test.isTrue(n.eq('1e+0'));
  test.isTrue(!n.eq(-1));
  test.isTrue(!n.eq(0.1));

  test.isTrue(!new Big(0.1).eq(0));
  test.isTrue(!new Big(1e9 + 1).eq(1e9));
  test.isTrue(!new Big(1e9 - 1).eq(1e9));
  test.isTrue(new Big(1e9 + 1).eq(1e9 + 1));
  test.isTrue(new Big(1).eq(1));
  test.isTrue(!new Big(1).eq(-1));

  test.isTrue(!new Big(1.23001e-2).lt(1.23e-2));
  test.isTrue(new Big(1.23e-2).lt(1.23001e-2));
  test.isTrue(!new Big(1e-2).lt(9.999999e-3));
  test.isTrue(new Big(9.999999e-3).lt(1e-2));
  test.isTrue(!new Big(1.23001e+2).lt(1.23e+2));
  test.isTrue(new Big(1.23e+2).lt(1.23001e+2));
  test.isTrue(new Big(9.999999e+2).lt(1e+3));
  test.isTrue(!new Big(1e+3).lt(9.9999999e+2));

  test.isTrue(!new Big(1.23001e-2).lte(1.23e-2));
  test.isTrue(new Big(1.23e-2).lte(1.23001e-2));
  test.isTrue(!new Big(1e-2).lte(9.999999e-3));
  test.isTrue(new Big(9.999999e-3).lte(1e-2));

  test.isTrue(!new Big(1.23001e+2).lte(1.23e+2));
  test.isTrue(new Big(1.23e+2).lte(1.23001e+2));
  test.isTrue(new Big(9.999999e+2).lte(1e+3));
  test.isTrue(!new Big(1e+3).lte(9.9999999e+2));

  test.isTrue(new Big(1.23001e-2).gt(1.23e-2));
  test.isTrue(!new Big(1.23e-2).gt(1.23001e-2));
  test.isTrue(new Big(1e-2).gt(9.999999e-3));
  test.isTrue(!new Big(9.999999e-3).gt(1e-2));

  test.isTrue(new Big(1.23001e+2).gt(1.23e+2));
  test.isTrue(!new Big(1.23e+2).gt(1.23001e+2));
  test.isTrue(!new Big(9.999999e+2).gt(1e+3));
  test.isTrue(new Big(1e+3).gt(9.9999999e+2));

  test.isTrue(new Big(1.23001e-2).gte(1.23e-2));
  test.isTrue(!new Big(1.23e-2).gte(1.23001e-2));
  test.isTrue(new Big(1e-2).gte(9.999999e-3));
  test.isTrue(!new Big(9.999999e-3).gte(1e-2));

  test.isTrue(new Big(1.23001e+2).gte(1.23e+2));
  test.isTrue(!new Big(1.23e+2).gte(1.23001e+2));
  test.isTrue(!new Big(9.999999e+2).gte(1e+3));
  test.isTrue(new Big(1e+3).gte(9.9999999e+2));
  ...
  test.isException(function () {new Big('12.345').eq(undefined)}, ".eq(undefined)");
  test.isException(function () {new Big('12.345').eq(null)}, ".eq(null)");
  test.isException(function () {new Big('12.345').eq(NaN)}, ".eq(NaN)");
  test.isException(function () {new Big('12.345').eq('NaN')}, ".eq('NaN')");
  test.isException(function () {new Big('12.345').eq([])}, ".eq([])");
  test.isException(function () {new Big('12.345').eq({})}, ".eq({})");
  test.isException(function () {new Big('12.345').eq('')}, ".eq('')");
  test.isException(function () {Big('12.345').eq(' ')}, ".eq(' ')");
  test.isException(function () {new Big('12.345').eq('hello')}, ".eq('hello')");
  test.isException(function () {new Big('12.345').eq('\t')}, ".eq('\t')");
  test.isException(function () {new Big('12.345').eq(new Date)}, ".eq(new Date)");
  test.isException(function () {new Big('12.345').eq(new RegExp)}, ".eq(new RegExp)");
  test.isException(function () {new Big('12.345').eq(function () {})}, ".eq(function () {})");
  ...
  test.isException(function () {new Big('12.345').eq('10.1.0')}, ".eq('10.1.0')");
  test.isException(function () {new Big('12.345').eq('0x16')}, ".eq('0x16')");
  test.isException(function () {new Big('12.345').eq('1e')}, ".eq('1e')");
  test.isException(function () {new Big('12.345').eq('8 e')}, ".eq('8 e')");
  test.isException(function () {new Big('12.345').eq('77-e')}, ".eq('77-e')");
  test.isException(function () {new Big('12.345').eq('123e.0')}, ".eq('123e.0')");
  test.isException(function () {new Big('12.345').eq('4e1.')}, ".eq('4e1.')");
  test.isException(function () {Big('12.345').eq(Infinity)}, ".eq(Infinity)");
  test.isException(function () {new Big('12.345').eq('-Infinity')}, ".eq('-Infinity')");

  test.isException(function () {new Big('0').gt(undefined)}, ".gt(undefined)");
  test.isException(function () {new Big('0').gt(null)}, ".gt(null)");
  test.isException(function () {new Big('0').gt(NaN)}, ".gt(NaN)");
  test.isException(function () {new Big('0').gt('NaN')}, ".gt('NaN')");
  test.isException(function () {new Big('0').gt([])}, ".gt([])");
  test.isException(function () {new Big('0').gt({})}, ".gt({})");
  test.isException(function () {new Big('0').gt('')}, ".gt('')");
  test.isException(function () {Big('0').gt(' ')}, ".gt(' ')");
  test.isException(function () {new Big('0').gt('hello')}, ".gt('hello')");
  test.isException(function () {new Big('0').gt('\t')}, ".gt('\t')");
  test.isException(function () {new Big('0').gt(new Date)}, ".gt(new Date)");
  test.isException(function () {new Big('0').gt(new RegExp)}, ".gt(new RegExp)");
  test.isException(function () {new Big('0').gt(function () {})}, ".gt(function () {})");
  ...
  test.isException(function () {new Big('0').gt('10.1.0')}, ".gt('10.1.0')");
  test.isException(function () {new Big('0').gt('0x16')}, ".gt('0x16')");
  test.isException(function () {new Big('0').gt('1e')}, ".gt('1e')");
  test.isException(function () {new Big('0').gt('8 e')}, ".gt('8 e')");
  test.isException(function () {new Big('0').gt('77-e')}, ".gt('77-e')");
  test.isException(function () {new Big('0').gt('123e.0')}, ".gt('123e.0')");
  test.isException(function () {new Big('0').gt('4e1.')}, ".gt('4e1.')");
  test.isException(function () {Big('0').gt(Infinity)}, ".gt(Infinity)");
  test.isException(function () {new Big('0').gt('-Infinity')}, ".gt('-Infinity')");

  test.isException(function () {new Big('9.9900E2').gte(undefined)}, ".gte(undefined)");
  test.isException(function () {new Big('9.9900E2').gte(null)}, ".gte(null)");
  test.isException(function () {new Big('9.9900E2').gte(NaN)}, ".gte(NaN)");
  test.isException(function () {new Big('9.9900E2').gte('NaN')}, ".gte('NaN')");
  test.isException(function () {new Big('9.9900E2').gte([])}, ".gte([])");
  test.isException(function () {new Big('9.9900E2').gte({})}, ".gte({})");
  test.isException(function () {new Big('9.9900E2').gte('')}, ".gte('')");
  test.isException(function () {Big('9.9900E2').gte(' ')}, ".gte(' ')");
  test.isException(function () {new Big('9.9900E2').gte('hello')}, ".gte('hello')");
  test.isException(function () {new Big('9.9900E2').gte('\t')}, ".gte('\t')");
  test.isException(function () {new Big('9.9900E2').gte(new Date)}, ".gte(new Date)");
  test.isException(function () {new Big('9.9900E2').gte(new RegExp)}, ".gte(new RegExp)");
  test.isException(function () {new Big('9.9900E2').gte(function () {})}, ".gte(function () {})");
  ...
  test.isException(function () {new Big('9.9900E2').gte('10.1.0')}, ".gte('10.1.0')");
  test.isException(function () {new Big('9.9900E2').gte('0x16')}, ".gte('0x16')");
  test.isException(function () {new Big('9.9900E2').gte('1e')}, ".gte('1e')");
  test.isException(function () {new Big('9.9900E2').gte('8 e')}, ".gte('8 e')");
  test.isException(function () {new Big('9.9900E2').gte('77-e')}, ".gte('77-e')");
  test.isException(function () {new Big('9.9900E2').gte('123e.0')}, ".gte('123e.0')");
  test.isException(function () {new Big('9.9900E2').gte('4e1.')}, ".gte('4e1.')");
  test.isException(function () {Big('9.9900E2').gte(Infinity)}, ".gte(Infinity)");
  test.isException(function () {new Big('9.9900E2').gte('-Infinity')}, ".gte('-Infinity')");

  test.isException(function () {new Big('12.345').lt(undefined)}, ".lt(undefined)");
  test.isException(function () {new Big('12.345').lt(null)}, ".lt(null)");
  test.isException(function () {new Big('12.345').lt(NaN)}, ".lt(NaN)");
  test.isException(function () {new Big('12.345').lt('NaN')}, ".lt('NaN')");
  test.isException(function () {new Big('12.345').lt([])}, ".lt([])");
  test.isException(function () {new Big('12.345').lt({})}, ".lt({})");
  test.isException(function () {new Big('12.345').lt('')}, ".lt('')");
  test.isException(function () {Big('12.345').lt(' ')}, ".lt(' ')");
  test.isException(function () {new Big('12.345').lt('hello')}, ".lt('hello')");
  test.isException(function () {new Big('12.345').lt('\t')}, ".lt('\t')");
  test.isException(function () {new Big('12.345').lt(new Date)}, ".lt(new Date)");
  test.isException(function () {new Big('12.345').lt(new RegExp)}, ".lt(new RegExp)");
  test.isException(function () {new Big('12.345').lt(function () {})}, ".lt(function () {})");
  ...
  test.isException(function () {new Big('12.345').lt('10.1.0')}, ".lt('10.1.0')");
  test.isException(function () {new Big('12.345').lt('0x16')}, ".lt('0x16')");
  test.isException(function () {new Big('12.345').lt('1e')}, ".lt('1e')");
  test.isException(function () {new Big('12.345').lt('8 e')}, ".lt('8 e')");
  test.isException(function () {new Big('12.345').lt('77-e')}, ".lt('77-e')");
  test.isException(function () {new Big('12.345').lt('123e.0')}, ".lt('123e.0')");
  test.isException(function () {new Big('12.345').lt('4e1.')}, ".lt('4e1.')");
  test.isException(function () {Big('12.345').lt(Infinity)}, ".lt(Infinity)");
  test.isException(function () {new Big('12.345').lt('-Infinity')}, ".lt('-Infinity')");

  test.isException(function () {new Big('12.345').lte(undefined)}, ".lte(undefined)");
  test.isException(function () {new Big('12.345').lte(null)}, ".lte(null)");
  test.isException(function () {new Big('12.345').lte(NaN)}, ".lte(NaN)");
  test.isException(function () {new Big('12.345').lte('NaN')}, ".lte('NaN')");
  test.isException(function () {new Big('12.345').lte([])}, ".lte([])");
  test.isException(function () {new Big('12.345').lte({})}, ".lte({})");
  test.isException(function () {new Big('12.345').lte('')}, ".lte('')");
  test.isException(function () {Big('12.345').lte(' ')}, ".lte(' ')");
  test.isException(function () {new Big('12.345').lte('hello')}, ".lte('hello')");
  test.isException(function () {new Big('12.345').lte('\t')}, ".lte('\t')");
  test.isException(function () {new Big('12.345').lte(new Date)}, ".lte(new Date)");
  test.isException(function () {new Big('12.345').lte(new RegExp)}, ".lte(new RegExp)");
  test.isException(function () {new Big('12.345').lte(function () {})}, ".lte(function () {})");
  ...
  test.isException(function () {new Big('12.345').lte('10.1.0')}, ".lte('10.1.0')");
  test.isException(function () {new Big('12.345').lte('0x16')}, ".lte('0x16')");
  test.isException(function () {new Big('12.345').lte('1e')}, ".lte('1e')");
  test.isException(function () {new Big('12.345').lte('8 e')}, ".lte('8 e')");
  test.isException(function () {new Big('12.345').lte('77-e')}, ".lte('77-e')");
  test.isException(function () {new Big('12.345').lte('123e.0')}, ".lte('123e.0')");
  test.isException(function () {new Big('12.345').lte('4e1.')}, ".lte('4e1.')");
  test.isException(function () {Big('12.345').lte(Infinity)}, ".lte(Infinity)");
  test.isException(function () {new Big('12.345').lte('-Infinity')}, ".lte('-Infinity')");
});
